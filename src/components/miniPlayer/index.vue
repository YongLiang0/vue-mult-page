<template>
    <div class="vm-player" ref="container" @click.stop="handleClickVideo">
        ...
        <!--模拟poster -->
        <div class="_poster" :style="{backgroundImage:`url(${options.cover})`}" v-show="!isPlaying&&isStart && options.cover"></div>
        ...
        <transition name="fade">
            <BaseControls @paused="handlePaused" @fullscreen="$emit('fullscreen',$event)" v-show="!isClearMode" />
        </transition>
    </div>
</template>
<script>
